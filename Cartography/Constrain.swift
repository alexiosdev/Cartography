...
///
public func constrain(_ view1: View, _ view2: View, replace group: ConstraintGroup = ConstraintGroup(), @noescape block: @noescape (LayoutProxy, LayoutProxy) -> ()) -> ConstraintGroup {
    let context = Context()
